...
// void SACM_MS02_Initial(SACM_MS02_WORKING_RAM*, uint8_t *MS02KernelRAMPtr, uint8_t AudOutType, uint8_t DacChannelNo, uint32_t Timer_SR);
...
extern void SACM_MS02_OKON_Enable(int32_t MidiChan, int32_t SustainType);
