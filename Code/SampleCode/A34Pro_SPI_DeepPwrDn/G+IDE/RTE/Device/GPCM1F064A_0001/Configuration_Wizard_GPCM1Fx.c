...
#define SECURITY_CHECKBOX_UNLOCK    (1)
//   <o.0> Security
//     <0=> Enable
//     <1=> Disable
// </e>

#define USER_OPT0_DEFINED    (0xFFFFFFFE)
...
#define USER_OPT1_DEFINED    (0xFFFFFCE0 | USER_OPT1_DEFINED_0 | USER_OPT1_DEFINED_1)
#if (((USER_OPT1_DEFINED & 0xFFFFFCE0) != 0xFFFFFCE0) || ((USER_OPT1_DEFINED & 0xFFFFFCE3) == 0xFFFFFCE3))
