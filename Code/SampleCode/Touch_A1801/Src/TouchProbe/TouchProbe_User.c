...
/*
 *  User Setting:
 *   - TP_OUTPUT_SEL: Select SPI0_IOA[12:9]/SPI0_IOB[4:1]/SPI1_IOA[3:0]/SPI1_IOA[21:18]
 */
#define  SPI0_IOA9_12				(1)
#define  SPI0_IOB1_4        (2)
#define  SPI1_IOA0_3        (3)
#define  SPI1_IOA18_21      (4)
#define  TP_OUTPUT_SEL      SPI1_IOA18_21             // User Setting
/*---------------------------------------------------------------------------------------
...
void F_TP_HW_Init(void)
{
  ...
  mTpHandle = SPI1;
	...
	#if TP_OUTPUT_SEL == SPI1_IOA18_21
	SET_BIT(CLOCK->APBCKEN, CLOCK_APBCKEN_SPI1_CLK_ENABLE);                                          // APB SPI1 Clock enable
	MODIFY_REG(IOFUNC->CTRL0, GPIOFUNC_CTRL0_SPI1_HWCS_EN_MSK, GPIOFUNC_CTRL0_SPI1_HWCS_DISABLE);    // SPI1 S/W CS
	MODIFY_REG(IOFUNC->CTRL0, GPIOFUNC_CTRL0_SPI1_IOSEL_MSK, GPIOFUNC_CTRL0_SPI1_IOA18_21);	
  mTpHandle = SPI1;
  GPIO_SetMode(GPIOA, 0x001C0000, GPIO_MODE_OUTPUT);
  GPIO_SetMode(GPIOA, 0x00200000, GPIO_MODE_INPUT);
	mTpCsPin = &GPIOA_OBIT->OBIT20;
	#endif		
	
	mTpHandle->CTRL = SPI_CTRL_MASTER_MODE | SPI_CTRL_CLK_SEL_PCLK_DIV_64 | SPI_CTRL_SPI_ENABLE | SPI_CTRL_MAUT_RW_EN_ENABLE;
