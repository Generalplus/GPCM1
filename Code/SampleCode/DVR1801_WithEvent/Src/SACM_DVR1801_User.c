 ...
 *   None.
 */
void DVR1801_User_DVR1801WithGpEvent_ServerLoop()
{
...
{
	mDvr1801DsAdcDmaHandle = DMA0;
	mDvr1801DacCh0DmaHandle = DMA0;
	mDvr1801DacCh1DmaHandle = DMA1;
...
void DVR1801_CB_StartPlay(const SACM_DVR1801_WORKING_RAM *Dvr1801WorkingRam)
{
	...
	GP_EVENTOR_Start(EVENTOR_CH0, (uint8_t *)(&Dvr1801WorkingRam->SpeechDataAddr[Dvr1801WorkingRam->DataLen]));
}
...
void DVR1801_CB_DecodeProcess(const SACM_DVR1801_WORKING_RAM *Dvr1801WorkingRam, int16_t *DstBufAddr, int16_t *SrcBufAddr)
{
  uint32_t GpEventFlag;
	...
	GpEventFlag = SACM_DVR1801_DecodeProcess(DstBufAddr, SrcBufAddr);
