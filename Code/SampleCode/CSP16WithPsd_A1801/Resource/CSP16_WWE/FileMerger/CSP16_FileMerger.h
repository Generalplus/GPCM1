...
*/ 
	...
	#include <stdint.h>
		...
		extern const uint8_t* CSP16_FileMerger_bin_Data;
		#define SEC_START_ADDR CSP16_FileMerger_bin_Data
	#else
		extern uint8_t _binary_CSP16_FileMerger_bin_start;
		extern uint32_t _binary_CSP16_FileMerger_bin_size;

		#define SEC_START_ADDR &_binary_CSP16_FileMerger_bin_start
	#endif
...
#define _CSP16_WWE_PACK                0       	//File  Index:0           File  Name:CSP16_WWE_pack.bin 
#define _CSP16_WWE_PACK_ADDR           (SEC_START_ADDR + 0x000010)	//File  Addr :0x000010    File  Name:CSP16_WWE_pack.bin 
