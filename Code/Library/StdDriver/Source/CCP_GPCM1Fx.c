...
void CCP0_PWMIO_Open(uint8_t IOSEL)
{
  ...
  if(IOSEL == IoSel_IOA0_3)
  {
    MODIFY_REG(IOFUNC->CTRL0,GPIOFUNC_CTRL0_CCP0_MSK,GPIOFUNC_CTRL0_CCP0_IOA0_3);
  }
  else
  {
    MODIFY_REG(IOFUNC->CTRL0,GPIOFUNC_CTRL0_CCP0_MSK,GPIOFUNC_CTRL0_CCP0_IOA13_16);
  }
 ...
 *          None.
 */
void CCP1_Capture_Initial(uint8_t TRG_MODE)
{
	SET_BIT(CLOCK->AHBCKEN, CLOCK_AHBCKEN_CCP1_CLK_ENABLE);	        //	Enable CCP1 Clock
